...
class Triangle {
 public:
  Triangle() {
    ...
    std::cout << "v3: " << vertex3 << std::endl;
  }
  Triangle(float v1, float v2, float v3)
      : vertex1(v1), vertex2(v2), vertex3(v3) {
    std::cout << "Triangle constructor with parameters" << std::endl;
    std::cout << "v1: " << vertex1 << std::endl;
    std::cout << "v2: " << vertex2 << std::endl;
    std::cout << "v3: " << vertex3 << std::endl;
  }
  ...
  Triangle(const Triangle& t) {
    std::cout << "Triangle copy constructor" << std::endl;
    vertex1 = t.vertex1;
    vertex2 = t.vertex2;
    vertex3 = t.vertex3;
  }
  ...
  Triangle& operator=(const Triangle& t) {
    std::cout << "Triangle copy assignment" << std::endl;
    vertex1 = t.vertex1;
    vertex2 = t.vertex2;
    vertex3 = t.vertex3;
    return *this;
